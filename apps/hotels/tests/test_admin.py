...
class TestAdminConfiguration:
    ...
    def test_hotel_admin_configuration(self):
        ...
        assert HotelAdmin.list_display == ['name', 'slug', 'type', 'brand', 'total_rooms', 'is_active', 'created_at']
    ...
    def test_roomtype_admin_configuration(self):
        ...
        assert RoomTypeAdmin.list_display == ['name', 'code', 'hotel', 'base_price', 'max_occupancy',
    ...
    def test_room_admin_configuration(self):
        ...
        assert RoomAdmin.list_display == ['room_number', 'hotel', 'room_type', 'floor', 'status',
                                          'cleaning_status', 'is_active']
        assert RoomAdmin.list_filter == ['hotel', 'room_type', 'status', 'cleaning_status', 'is_active', 'created_at']
...
class TestAdminFunctionality:
    ...
    def test_admin_site_has_correct_models_count(self):
        ...
        hotel_models = [model for model in admin.site._registry.keys()
