...
class GuestAdmin(admin.ModelAdmin):
    ...
    list_display = ['full_name', 'email', 'phone', 'nationality', 'loyalty_tier',
                    'loyalty_points', 'vip_status', 'created_at']
    ...
    fieldsets = (
        ...
        ('Personal Details', {
            'fields': ('date_of_birth', 'nationality', 'address')
        }),
        ...
        ('Loyalty Program', {
            'fields': ('loyalty_tier', 'loyalty_points', 'vip_status')
        }),
        ('Account', {
            'fields': ('user',)
        }),
